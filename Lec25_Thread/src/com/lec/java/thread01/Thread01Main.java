...
public class Thread01Main {
	...
	public static void main(String[] args) {
		...
		// 3. Thread 클래스의 인스턴스를 생성
		Thread thread = new MyThread("Hello Java");
		Thread thread2 = new MyThread("안녕하세요");
		...
		thread = new MyThread("Hello Java 2.0");
		thread.start();
		
		// Working Thread : 작업 쓰레드
		// 여기까지는 메인 포함한 4개 쓰레드가 돌고 있다
