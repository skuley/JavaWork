...
public class Crawl17Main {
	...
	public void init() {
		System.setProperty(WEB_DRIVER_ID, WEB_DRIVER_PATH); // 유저 데이터니 뭐니 다  뭐라고?????????? 다시 물어보자
	...
	public void naverLogin() {
		...
		//System.out.println(element.getSize()); // element.getSize() 좌표 사이즈
		element.sendKeys("skuley"); // 키보드 타이핑 입력
		
		// 패스워드 입력
		element = driver.findElement(By.id("pw"));
		element.sendKeys("since-1993");
		
		// 로그인 버튼 클릭
		element = driver.findElement(By.id("btn_global"));
		element.click();
	...
	public void likeFaceBook() {
		...
		//System.out.println(element.getSize()); // element.getSize() 좌표 사이즈
		element.sendKeys("coolsung7@gmail.com"); // 키보드 타이핑 입력
		...
		// 로그인 버튼 클릭
//		element = driver.findElement(By.id("u_0_4"));
//		element.click();
	...
	public void naverRelated(String keyword) {
		...
		System.out.println(list.size() + "객");
