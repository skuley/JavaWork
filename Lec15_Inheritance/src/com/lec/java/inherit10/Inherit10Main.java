...
class TestSub extends TestSuper{
	...
	// Cannot reduce the visibility of the inherited method from TestSuper "access modifier를 줄일수는 없다는 에러"
	...
	@Override
	public void test4() {
		// The return type is incompatible with TestSuper.test4() // return 타입까지는 동일해야한다.
		super.test4();
	}
