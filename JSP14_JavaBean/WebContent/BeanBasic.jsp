...
<%-- form 에서 넘어온 값을 bean 객체가 바로 받을수 잇다.
	 bean 의 필드명 (getter/setter) 과 form의 name 이 일치해야 한다 --%>
...
<%-- person3.setGender(request.getParameter("gender")) // 이것과 비슷하다 --%>


<%-- parameter를 일괄로 받아오는 것이다  --%>
...
<body>
	...
	<h3>person1</h3>
	이름:
	<jsp:getProperty name="person1" property="name" /><br> 나이:
	<jsp:getProperty name="person1" property="age" /><br> 아이디:
	<jsp:getProperty name="person1" property="id" /><br> 성별:
	<jsp:getProperty name="person1" property="gender" /><br>
	<%--
		<%= person1.getName()%>
	 --%>
	...
	<h3>person2</h3>
	이름:
	<jsp:getProperty name="person2" property="name" /><br> 나이:
	<jsp:getProperty name="person2" property="age" /><br> 아이디:
	<jsp:getProperty name="person2" property="id" /><br> 성별:
	<jsp:getProperty name="person2" property="gender" /><br>

	<h3>person3</h3>
	이름:
	<jsp:getProperty name="person3" property="name" /><br> 나이:
	<jsp:getProperty name="person3" property="age" /><br> 아이디:
	<jsp:getProperty name="person3" property="id" /><br> 성별:
	<jsp:getProperty name="person3" property="gender" /><br>
	
	<h3>person4</h3>
	이름:
	<jsp:getProperty name="person4" property="name" /><br> 나이:
	<jsp:getProperty name="person4" property="age" /><br> 아이디:
	<jsp:getProperty name="person4" property="id" /><br> 성별:
	<jsp:getProperty name="person4" property="gender" /><br>
