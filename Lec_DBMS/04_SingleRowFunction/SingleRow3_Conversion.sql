...
-- 형변환하는 TO_NUMBER() 함수를 호출한다
SELECT TO_NUMBER('1') + 1 FROM DUAL ; 

-- 날짜에서 문자열로 변환 TO_CHAR()
SELECT 
SYSDATE, 
...
SELECT 
	...
	TO_CHAR(123456, '999,999') "천단위에 구분기호" 
FROM DUAL ;
...
-- TO_DATE()
SELECT 
	TO_DATE('20200408' , 'YYYY-MM-DD') TO_DATE 
FROM DUAL ;
...
SELECT NAME , 
	...
	TO_CHAR( PAY * 12 * 1.1, '99,999') "10% 인상 연봉"
FROM T_PROFESSOR 
WHERE HIREDATE < TO_DATE('19991231', 'YYYY-MM-DD') ;
