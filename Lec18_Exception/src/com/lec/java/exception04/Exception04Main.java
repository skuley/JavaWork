...
public class Exception04Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			str.charAt(20); // StringOutOfBoundsException
			...
			// Exception 은 모든 exception들 (상속된 예외 객체들까지도) catch 할수 있다.
			// (다형성!)
			System.out.println("아몰랑~ Exception 발생" + e.getMessage());
		}
		
		// 조상인 Exception이 하위 예외 클래스 보다 먼저 사용할 수 없다. 그럴때 발생하는 에러가 Unreachable
