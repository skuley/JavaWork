...
public class Method02Main {
	...
	//   2) int y
	// 리턴타입: int
	public static int add(int x, int y) { // must return a result of type int int타입을 return해라!!
		int result = x + y;
		return result; // return (메소드 종료, 값을 리턴)
	} // end add()
