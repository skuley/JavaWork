...
public class Method03Main {
	...
	public static char calcGrade(double calcAvg) {
		if(calcAvg >= 90) return 'A';
		if(calcAvg >= 80) return 'B';
		if(calcAvg >= 70) return 'C';
		if(calcAvg >= 60) return 'D';
		if(calcAvg >= 50) return 'F';
	}
