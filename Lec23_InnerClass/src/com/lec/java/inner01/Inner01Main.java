...
public class Inner01Main {
	...
	public static void main(String[] args) {
		...
		TestOuter.TestInner inOut = out.new TestInner(111);
		inOut.printOuterValue();
		inOut.printInnerValue();
		
		System.out.println();
		
		// 하나의 외부 클래스 인스턴스를 이용해서
		// 멤버 내부 클래스의 인스턴스는 여러개 생성 가능
		TestOuter.TestInner inOut2 = out.new TestInner(123);
		inOut2.printOuterValue();
		inOut2.printInnerValue();
		
		
		// TODO
		// 새로운 외부 클래스 인스턴스 생성
		// out2 외부 클래스 인스턴스 생성
		// out2 로부터 in4, in5 이름으로 내부 클래스 객체 만드세요
		
		TestOuter out2 = new TestOuter(200);
		TestOuter.TestInner in4 = out2.new TestInner(150);
