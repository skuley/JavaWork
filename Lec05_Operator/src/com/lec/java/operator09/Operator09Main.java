...
public class Operator09Main {
	...
	public static void main(String[] args) {
		...
		byte b1 = 10, b2 = 20;
//		byte b3 = b1 + b2; // byte + byte = int 타입으로 반환
		
		short s1 = 10, s2 = 20;
//		short s3 = s1 + s2; // short + short = int
		
		char ch1 = 10, ch2 = 20;
//		char ch3 = ch1 + ch2; int 타입으로 값을 반환한다
		char ch3 = (char)(ch1 + ch2); // 따라서 명시적 형변환
		
		long l1 = 10L;
//		int n4 = n1 + l1; // 이것 또한 int 타입
...
//		f3 = f1 + d1; // float + double = double 타입  type Mismatch
