...
<h3>다운로드 link2: post + Java</h3>
<% for(int i = 0; i < originalFileNames.length; i++){ %>
	<form action="frm<%=i%>" action="FileDownload.jsp" method="post">
...
<% for(int i = 0; i < originalFileNames.length; i++){ %>
	<div style="width: 300px">
		<img src="upload/<%=fileSystemNames[i] %>" style="width:100%; height:auto">
	</div>
<% } %>
