...
public class Generic01Main {
	...
	public static void main(String[] args) {
		...
		BananaBox bB1 = new BananaBox(b1);
		bB1.pullOut().displayNum();
		...
		FruitBox<Banana> banBox = new FruitBox<Banana>(ban);
		banBox.pullOut().displayNum();
...
class FruitBox<T>{
	...
	public T pullOut() { return this.fruit;}
}
